...
// - Smooth hover transitions using Tailwind utilities
 ...
 const cardsData = [
  ...
  price: '$45',
  description: 'A lightweight serum that brightens dull skin, evens tone, and restores a youthful glow.'
},
{
  id: 2,
  image: '/Beauty/2.png',
  ...
  price: '$25',
  description: 'A creamy matte lipstick that delivers rich color with a smooth, long-lasting finish.'
},
{
  id: 3,
  image: '/Beauty/3.png',
  ...
  price: '$38',
  description: 'An ultra-hydrating moisturizer infused with hyaluronic acid for all-day smoothness.'
},
{
  id: 4,
  image: '/Beauty/4.png',
  ...
  price: '$32',
  description: 'A nourishing oil that tames frizz, adds shine, and keeps hair soft and healthy.'
},
{
  id: 5,
  image: '/Beauty/5.png',
  ...
  price: '$28',
  description: 'A refreshing rose-infused mask that hydrates, purifies, and soothes the skin.'
},
{
  id: 6,
  image: '/Beauty/6.png',
  ...
  price: '$30',
  description: 'A nourishing shampoo enriched with argan oil to strengthen and repair damaged hair.'
},
{
  id: 7,
  image: '/Beauty/7.png',
  ...
  price: '$22',
  description: 'A gentle toner that tightens pores, balances pH, and refreshes your skin.'
},
{
  id: 8,
  image: '/Beauty/8.png',
...
},
{
  ...
  price: '$55',
  description: 'An anti-aging eye cream that reduces puffiness, fine lines, and dark circles.'
},
{
  id: 10,
  image: '/Beauty/10.png',
  ...
  price: '$40',
  description: 'A lightweight liquid foundation offering smooth coverage and a natural satin finish.'
},
{
  id: 11,
  image: '/Beauty/11.png',
  ...
  subtitle: 'Makeup • 10g',
  price: '$15',
  description: 'A hydrating lip balm with a hint of berry tint to keep lips soft and naturally glowing.'
},
{
  id: 12,
  image: '/Beauty/12.png',
  ...
  price: '$27',
  description: 'A deeply moisturizing lotion that softens skin with coconut oil and vitamin E.'
},
{
  id: 13,
  image: '/Beauty/13.png',
  ...
  price: '$26',
  description: 'A deep-cleansing facial wash that removes impurities and clears clogged pores.'
},
{
  id: 14,
  image: '/Beauty/14.png',
...
},
{
  ...
  price: '$20',
  description: 'A soothing gel perfect for hydrating and cooling the skin after sun exposure.'
},
{
  id: 16,
  image: '/Beauty/16.png',
...
},
{
  ...
  subtitle: 'Skincare • 120ml',
  price: '$24',
  description: 'A refreshing facial mist infused with natural botanicals for instant hydration.'
},
{
  id: 18,
  image: '/Beauty/18.png',
  ...
  price: '$33',
  description: 'An exfoliating scrub that removes dead skin and leaves your body smooth and glowing.'
},
{
  id: 19,
  image: '/Beauty/19.png',
...
},
{
  ...
  price: '$31',
  description: 'A refreshing body mist with aquatic and citrus notes for a clean, energizing scent.'
}
