        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-4">
              <button className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-indigo-600 text-white text-sm font-medium shadow-sm transition-transform transform hover:scale-105 focus:outline-none">
                Add to Cart
              </button>
              <button
                aria-label="save"
