          ...
          <ul className="flex items-center justify-end gap-1.5 lg:gap-3">
            ...
            <li>
              <Link
                to="/account"
                aria-label="Account"
                className={`block p-1.5 ${isActive("/account", pathname) ? "text-blue-700" : "text-blue-500 hover:text-blue-700"}`}
              >
            ...
            <li className="relative">
              <Link
                to="/cart"
                aria-label="Cart"
                className={`block p-1.5 ${isActive("/cart", pathname) ? "text-blue-700" : "text-blue-500 hover:text-blue-700"}`}
              >
                <span className="absolute -top-1 -right-1 z-10 bg-blue-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">
                  {cartCount ?? "?"}
                </span>
